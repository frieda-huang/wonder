...
def create_instruction(user_preferences: dict, number_of_jobs_to_search: int) -> str:
    ...
    Instructions:
        1.	Analyze the resume content alongside the user’s preferences (location, role_type, and aspirations) to understand their experience and goals.
    ...
    Please output the job results in the following JSON format and **only** return the JSON object without any additional text, explanations, or comments:
    {{
